      ...
      <div class="grid grid-cols-1 md:grid-cols-12 gap-8 pb-12">
        ...
        <div class="md:col-span-4 mx-auto">
          <a href="/" class="inline-block">
            <img src="/api/placeholder/200/50" alt="Magazine Logo" class="h-8" />
          </a>
          <!-- Social Icons -->
        ...
        <div class="md:col-span-4 mx-auto md:text-left text-center md:ml-56">
          ...
          <ul class="space-y-3 text-xs">
            ...
            <li><a href="#" class="hover:text-gray-300">About Vanity Fair</a></li>
      ...
      <div class="border-t border-gray-700 pt-8">
        <div class="flex flex-wrap justify-between items-center gap-4">
            <div class="flex flex-wrap gap-4 text-center text-sm flex-col md:flex-row justify-center md:justify-start w-full md:w-auto">
              <a href="#" class="hover:text-gray-300">User Agreement</a>
              <span class="text-gray-500 hidden md:block">|</span>
              <a href="#" class="hover:text-gray-300">Privacy Policy</a>
              <span class="text-gray-500 hidden md:block">|</span>
              <a href="#" class="hover:text-gray-300">Your California Privacy Rights</a>
              <span class="text-gray-500 hidden md:block">|</span>
              <a href="#" class="hover:text-gray-300">VF Media Kit</a>
              <span class="text-gray-500 hidden md:block">|</span>
              <a href="#" class="hover:text-gray-300">Accessibility Help</a>
            </div>
