                            ...
                            <form method="POST" enctype="multipart/form-data" novalidate>
                                <div class="card-body">
                                    <div class="row gy-4">
                                        ...
                                        <div>
                                            <p class=" "><b> Author  Bio : </b></p>

                                            <input type="text" class="form-control" id="input" name="bio"
                                                required placeholder=" author bio"
                                                value="{{ isset($author) ? $author->bio : old('bio') }}" />

                                        </div> 
                                        
                                        <div class="">

                                            <p class="mb-2 "><b>Author Image  : </b></p>

                                            <input type="file" class="form-control" 
                                                name="author_image"  
                                                accept="image/*"   id="author_image"/>
                                        </div>

                                        <div>

                                        <p class="mb-2 "><b> Author Preview : </b></p>
                                        <img src="{{ isset($author) ? $author->image : "" }}" alt="Image Not Found"
                                        id="author_prev" width="200px" style="{{ isset($author) ? '' : 'display : none' }}">
