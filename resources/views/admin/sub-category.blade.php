                        ...
                        <div class="card custom-card">
                            ...
                            <form method="POST"  novalidate>
                                <div class="card-body">
                                    <div class="row gy-4">
                                        <div>
                                            <p class=" "><b> Sub Category Name : </b></p>

                                            <input type="text" class="form-control" id="input" name="sub-category"
                                        ...
                                        <div class="">
                                            ...
                                            <p class="mb-2 "><b> Inside Which Parent Category ? : </b></p>
                                            <select name="parent-category" id="headline" class="form-control" required>
