                                    ...
                                    <div class="row gy-4">
                                        <div>
                                            ...
                                            <input type="text" class="form-control" id="input" name="category"
                                                ...
                                                value="{{ isset($category) ? $category->category : old('title') }}" />
                                        ...
                                        <div class="">
                                            ...
                                            <select name="headline" id="headline" class="form-control">
                                                <option value="false" {{ isset($category) && $category->headline ? "selected" : '' }}>No</option>
                                                <option value="true" {{ isset($category) && $category->headline ? "selected" : '' }}>Yes</option>
                                              </select>
                                        </div>
